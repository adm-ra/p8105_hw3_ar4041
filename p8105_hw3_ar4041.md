...
accel_df = 
  ...
  group_by(week, day) %>% 
  ggplot(aes(x = active_num , y = active_val, color = day, alpha = .5)) + 
  geom_point() + 
  geom_smooth() +
...
Based on this graph, it appears that activity
...
<img src="p8105_hw3_ar4041_files/figure-gfm/unnamed-chunk-2-1.png" width="90%" />
...
<img src="p8105_hw3_ar4041_files/figure-gfm/unnamed-chunk-3-1.png" width="90%" />
